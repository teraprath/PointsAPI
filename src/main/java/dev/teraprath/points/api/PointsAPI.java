...
public class PointsAPI {
    ...
    public void init() {
        Plugin depend = plugin.getServer().getPluginManager().getPlugin("PointsAPI");
        if (depend != null) {
            ...
            plugin.getLogger().warning("PointsAPI is not installed! Instructions: https://github.com/teraprath/PointsAPI/wiki/1.-Getting-Started");
            plugin.getLogger().warning("Download on GitHub: https://github.com/teraprath/PointsAPI/releases/latest");
        }
