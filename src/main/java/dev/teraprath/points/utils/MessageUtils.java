...
public class MessageUtils {
    ...
    public MessageUtils() {
        ...
        this.self = prefix + Main.getInstance().getConfig().getString("language.points_self");
        this.others = prefix + Main.getInstance().getConfig().getString("language.points_others");;
